  ...
  return (
    <>
      <div className="night">
        ...
        >
          Îmi pare rău că te-am supărat. Ieri am observat că ți-au plăcut
          florile, și cum nu îți pot oferi unele în persoană, m-am gândit să îți
          fac una online. Sper că îți place!
        </div>
      </div>
